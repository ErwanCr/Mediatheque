...
class __TwigTemplate_8aad4b3edee653e3f66374fe12e2361aeb2429bbd89ddcc4e91e056122824d65 extends \Twig\Template
{
    private $source;
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["shipment"]) {
            // line 3
            echo "        ";
            $this->loadTemplate("@SyliusShop/Checkout/SelectShipping/_shipment.html.twig", "@SyliusShop/Checkout/SelectShipping/_form.html.twig", 3)->display(twig_array_merge($context, ["form" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 3, $this->source); })()), "shipments", []), $context["key"], [], "array")]));
            // line 4
            echo "    ";
...
", "@SyliusShop/Checkout/SelectShipping/_form.html.twig", "/mnt/d/Fac/L3/Mediatheque/Mediatheque/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/SelectShipping/_form.html.twig");
    }
}
