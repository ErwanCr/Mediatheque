...
class __TwigTemplate_656b363c8695676542b4f2c7d0c48e7311fb4ab445af7fdbaded1cd858065709 extends \Twig\Template
{
    private $source;
...
";
    ...
    {
        return new Source("{% for key, field in data if field is not null %}
    <strong>{{ key|humanize }}</strong>: {{ field }}<br/>
{% endfor %}
", "@SyliusUi/Grid/Field/logData.html.twig", "/mnt/d/Fac/L3/Mediatheque/Mediatheque/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Grid/Field/logData.html.twig");
    }
}
