...
class __TwigTemplate_9e76e49efa120b07dd496355dd5e463dbd7644a5f6cf06d95837fa71ba601176 extends \Twig\Template
{
    private $source;
    ...
    ";
        // line 2
        $this->loadTemplate((("@SyliusAdmin/Order/Label/PaymentState/" . twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 2, $this->source); })()), "paymentState", [])) . ".html.twig"), "@SyliusAdmin/Order/Show/_payments.html.twig", 2)->display(twig_array_merge($context, ["value" => ("sylius.ui." . twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 2, $this->source); })()), "paymentState", [])), "attached" => true]));
        // line 3
        echo "    ";
        if (twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 3, $this->source); })()), "hasPayments", [])) {
            // line 4
        ...
        <div class=\"ui relaxed divided list\" id=\"sylius-payments\">
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 6, $this->source); })()), "payments", []));
            $context['loop'] = [
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["payment"]) {
                // line 7
                echo "                ";
                $this->loadTemplate("@SyliusAdmin/Order/Show/_payment.html.twig", "@SyliusAdmin/Order/Show/_payments.html.twig", 7)->display($context);
                // line 8
                echo "            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    {
        return new Source("<div class=\"ui segment\" id=\"payment-state\">
...
", "@SyliusAdmin/Order/Show/_payments.html.twig", "/mnt/d/Fac/L3/Mediatheque/Mediatheque/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_payments.html.twig");
    }
}
