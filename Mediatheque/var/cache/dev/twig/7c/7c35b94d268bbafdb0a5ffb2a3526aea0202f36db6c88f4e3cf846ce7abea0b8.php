...
class __TwigTemplate_7a95ab5af77cf6235e405fe8f659af9b4aab429d002cf60c0835c83988e2fe87 extends \Twig\Template
{
    private $source;
        ...
        <div class=\"sub header\">
            <div class=\"ui horizontal divided list\">
                <div class=\"item\" id=\"sylius-order-currency-code\">
                    ";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 10, $this->source); })()), "currencyCode", []), "html", null, true);
        echo "
                </div>
                <div class=\"item\" id=\"sylius-order-locale-name\">
                    ";
        // line 13
        echo $context["flags"]->macro_fromLocaleCode(twig_get_attribute($this->env, $this->source, (isset($context["sylius"]) || array_key_exists("sylius", $context) ? $context["sylius"] : (function () { throw new RuntimeError('Variable "sylius" does not exist.', 13, $this->source); })()), "localeCode", []));
        echo $this->extensions['Sonata\IntlBundle\Twig\Extension\LocaleExtension']->locale(twig_get_attribute($this->env, $this->source, (isset($context["sylius"]) || array_key_exists("sylius", $context) ? $context["sylius"] : (function () { throw new RuntimeError('Variable "sylius" does not exist.', 13, $this->source); })()), "localeCode", []));
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  62 => 13,  56 => 10,  49 => 6,  43 => 2,  41 => 1,);
    }
...
", "SyliusShopBundle:Checkout/Complete:_header.html.twig", "/mnt/d/Fac/L3/Mediatheque/Mediatheque/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/Complete/_header.html.twig");
    }
}
