...
class __TwigTemplate_2b6b2d6d27cb8c1d1313eff60b833cb2efbaa866e9b6096f74f1c1ae6e838436 extends \Twig\Template
{
    private $source;
    ...
    <div class=\"ui fluid stackable items\">
        ...
        foreach ($context['_seq'] as $context["key"] => $context["choice_form"]) {
            // line 7
            echo "            ";
            $this->loadTemplate("@SyliusShop/Checkout/SelectPayment/_choice.html.twig", "@SyliusShop/Checkout/SelectPayment/_payment.html.twig", 7)->display(twig_array_merge($context, ["form" => $context["choice_form"], "method" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 7, $this->source); })()), "method", []), "vars", []), "choices", []), $context["key"], [], "array"), "data", [])]));
            // line 8
            echo "        ";
...
", "@SyliusShop/Checkout/SelectPayment/_payment.html.twig", "/mnt/d/Fac/L3/Mediatheque/Mediatheque/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/SelectPayment/_payment.html.twig");
    }
}
