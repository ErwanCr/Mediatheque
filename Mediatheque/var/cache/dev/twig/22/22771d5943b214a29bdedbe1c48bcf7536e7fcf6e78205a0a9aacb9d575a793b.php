...
class __TwigTemplate_acf77eaf5231393cbb5d6fdcd7e5e02be16f35247a9ff27da05d0c253681fb28 extends \Twig\Template
{
    private $source;
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 6, $this->source); })()), "request", []), "attributes", []), "get", [0 => "id"], "method")], 3 => ["label" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.ui.orders")]];
        // line 10
        echo "
";
        // line 11
...
", "SyliusAdminBundle:Customer/Order/Index:_breadcrumb.html.twig", "/mnt/d/Fac/L3/Mediatheque/Mediatheque/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Customer/Order/Index/_breadcrumb.html.twig");
    }
}
