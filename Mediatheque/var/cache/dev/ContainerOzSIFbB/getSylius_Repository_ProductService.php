...
return $this->services['sylius.repository.product'] = new \Sylius\Bundle\CoreBundle\Doctrine\ORM\ProductRepository($a, $a->getClassMetadata('App\\Entity\\Product\\Product'));
