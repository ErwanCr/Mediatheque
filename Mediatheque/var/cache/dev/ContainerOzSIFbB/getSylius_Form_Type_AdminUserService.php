...
return $this->services['sylius.form.type.admin_user'] = new \Sylius\Bundle\CoreBundle\Form\Type\User\AdminUserType('App\\Entity\\User\\AdminUser', $this->parameters['sylius.form.type.admin_user.validation_groups']);
