...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->privates['http_exception_listener'])) + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['validator'])) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->privates['swiftmailer.email_sender.listener'])) + (int) (isset($this->privates['form.type.entity'])) + (int) (isset($this->services['sylius.context.cart.new'])) + (int) (isset($this->services['fos_rest.view_handler']));
}), ['http_exception_listener' => 'reset', 'profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'security.token_storage' => 'setToken', 'swiftmailer.email_sender.listener' => 'reset', 'form.type.entity' => 'reset', 'sylius.context.cart.new_shop_based' => 'reset', 'fos_rest.view_handler.default' => 'reset']);
