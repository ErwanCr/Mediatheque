...
return $this->services['sylius.form.type.currency'] = new \Sylius\Bundle\CurrencyBundle\Form\Type\CurrencyType('App\\Entity\\Currency\\Currency', $this->parameters['sylius.form.type.currency.validation_groups']);
