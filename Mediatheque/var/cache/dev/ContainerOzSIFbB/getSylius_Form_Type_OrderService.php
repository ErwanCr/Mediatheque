...
return $this->services['sylius.form.type.order'] = new \Sylius\Bundle\OrderBundle\Form\Type\OrderType('App\\Entity\\Order\\Order', $this->parameters['sylius.form.type.order.validation_groups']);
