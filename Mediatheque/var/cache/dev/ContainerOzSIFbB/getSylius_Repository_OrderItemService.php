...
return $this->services['sylius.repository.order_item'] = new \Sylius\Bundle\OrderBundle\Doctrine\ORM\OrderItemRepository($a, $a->getClassMetadata('App\\Entity\\Order\\OrderItem'));
