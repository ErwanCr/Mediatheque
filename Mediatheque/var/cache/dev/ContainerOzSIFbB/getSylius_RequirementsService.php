...
return $this->services['sylius.requirements'] = new \Sylius\Bundle\CoreBundle\Installer\Requirement\SyliusRequirements([0 => new \Sylius\Bundle\CoreBundle\Installer\Requirement\SettingsRequirements($a), 1 => new \Sylius\Bundle\CoreBundle\Installer\Requirement\ExtensionsRequirements($a), 2 => new \Sylius\Bundle\CoreBundle\Installer\Requirement\FilesystemRequirements($a, $this->targetDirs[0], ($this->targetDirs[2].'/log'))]);
