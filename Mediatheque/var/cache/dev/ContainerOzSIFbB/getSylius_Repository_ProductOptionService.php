...
return $this->services['sylius.repository.product_option'] = new \Sylius\Bundle\CoreBundle\Doctrine\ORM\ProductOptionRepository($a, $a->getClassMetadata('App\\Entity\\Product\\ProductOption'));
